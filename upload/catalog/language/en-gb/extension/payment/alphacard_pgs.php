<?php
// Text
$_['text_title']                            = 'Alpha Payment Gateway Services';
$_['text_callback']                         = 'Alpha Payment Gateway Services: %s %s in Transaction #%s for this order.';
...
$_['text_card_brand_alphacard']            = 'Alpha';
...
$_['text_items']                            = 'Item(s)';
$_['text_log_notification_intro']           = '[Alpha Payment Gateway Services - NOTIFICATION %s]: ';
$_['text_log_validate_callback_intro']      = '[Alpha Payment Gateway Services - CALLBACK VALIDATE]: ';
$_['text_log_api_intro']                    = '[Alpha Payment Gateway Services - REST API %s]: ';

// Error
$_['error_session']                         = 'Error: Could not establish payment session. Alpha Payment Gateway Services cannot proceed.';
...
$_['error_event_missing']                   = 'Configuration error: Alpha Payment Gateway Services was not initialized properly. Make sure the event catalog/controller/checkout/checkout/before > extension/payment/alphacard_pgs/init is enabled!';
...
// Warning
$_['warning_test_mode']                     = 'Warning: Alpha Payment Gateway Services is running in test mode. Note: Test orders above &#36;100 may not get processed.';
